...
<section>
     <horizontal-image-text>
      <img slot="image-content" src="@/assets/images/registration.jpg" alt="picture of a bank vault" class="object-cover w-3/6 h-full">
      <register-form slot="text-content"></register-form>
    </horizontal-image-text>
</section>
</template>
...
import  RegisterForm from './register-template.vue';
