...
export default class Margins extends Vue {
 name = 'margins';
 marginLeftButton: ButtonIconNumeric = new ButtonFactory().createButton('numeric', 'margin-left') as ButtonIconNumeric; 
 marginRightButton: ButtonIconNumeric = new ButtonFactory().createButton('numeric', 'margin-right') as ButtonIconNumeric; 
 marginTopButton: ButtonIconNumeric = new ButtonFactory().createButton('numeric', 'margin-top') as ButtonIconNumeric; 
 marginBottomButton: ButtonIconNumeric = new ButtonFactory().createButton('numeric', 'margin-bottom') as ButtonIconNumeric; 
